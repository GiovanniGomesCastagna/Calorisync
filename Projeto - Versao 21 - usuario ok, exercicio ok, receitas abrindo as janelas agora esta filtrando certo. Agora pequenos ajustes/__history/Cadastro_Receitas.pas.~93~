...
begin
  ...
  // Limpa e recria as colunas (modo seguro)
  lista_alimento.Columns.Clear;
  lista_alimento.DefaultDrawing := True;

  // Cria colunas dinamicamente com base nos campos do dataset
