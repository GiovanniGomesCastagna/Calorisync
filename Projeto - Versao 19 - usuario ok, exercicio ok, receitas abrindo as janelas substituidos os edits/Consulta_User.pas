...
begin
  ...
  OcultarColunaSenha; // 👈 garante que SENHA não apareça
...
begin
  ...
  OcultarColunaSenha; // 👈 também aqui
...
begin
  ...
  try
    ...
    OcultarColunaSenha; // 👈 também garante após exclusão
...
begin
  try
    ...
    begin
      Salvar.Caption := 'Cadastrar';
      MessageDlg('Documento não encontrado. Você pode prosseguir com o cadastro.', mtInformation, [mbOK], 0);
    end;
    ...
    begin
      if IsCPF then
        FDQuery1.Locate('CPF', Documento, [])
      else
        FDQuery1.Locate('CNPJ', Documento, []);
    end;
...
begin
  ...
  begin
    ...
    begin
      Col.Visible := False;
      Exit; // achou e ocultou, pode sair
    end;
  end;
end;
